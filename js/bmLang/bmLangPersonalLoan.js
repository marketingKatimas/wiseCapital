...
const PersonalLoanServicesDes = document.getElementById('PersonalLoanServicesDes');
...
function updateTitle(language) {
    if (language === 'bm') {
        ...
        PersonalLoanTitle.textContent = 'Pembiayaan Peribadi';
    } else {
        OurServicesTitle.textContent = 'Our Services';
        HomeTitle.textContent = 'Home';
        PersonalLoanTitle.textContent = 'Personal Loan';
    }
}
...
function updateContent(language) {
    if (language === 'bm') {
        ...
        PersonalLoanServicesDes.textContent = ' Dengan pembiayaan peribadi kami, anda akan menerima pelan direka khas berdasarkan kelayakan kredit dan pendapatan anda, agar bayaran balik anda mengikut bajet tanpa membebankan kewangan anda.';
    } else {
        PersonalLoanServices.textContent = 'Personal Loan';
        PersonalLoanServicesDes.textContent = 'With our personal loan, you will receive a personalised plan based on your creditworthiness and income, so your monthly repayments are well within budget, without overburdening your finance.';
    }
}
