...
function updateContent(language) {
    if (language === 'bm') {
        ...
        WeddingLoanServicesDes.textContent = 'Untuk yang ingin berkahwin, biayai majlis kahwin idaman anda dengan pembiayaan perkahwinan kami! Pembiayaan ini merangkumi segala keperluan kahwin anda supaya anda dapat nikmati hari bahagia tanpa gelisah';
    } else {
        WeddingLoanServices.textContent = 'Wedding Loan';
        WeddingLoanServicesDes.textContent = 'Getting married? Fund your dream wedding with us! Our wedding loan is designed to cover all your wedding expenses so you can enjoy the day you’ll remember forever.';
    }
}
