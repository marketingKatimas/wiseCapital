...
const DebtConsolidationServicesDes = document.getElementById('DebtConsolidationServicesDes');
...
function updateContent(language) {
    if (language === 'bm') {
        ...
        DebtConsolidationServicesDes.textContent = 'Jangan biarkan hutang berlambak membebankan anda! Urus dan kurangkan beban faedah dan kawal kewangan anda dengan khidmat penyatuan hutang kami yang berfaedah rendah.';
    } else {
        DebtConsolidationServices.textContent = 'Debt Consolidation';
        DebtConsolidationServicesDes.textContent = 'Don’t let multiple debts weigh you down! Manage and reduce your interest burden and take control of your finances with our low interest rate solution.';
    }
}
