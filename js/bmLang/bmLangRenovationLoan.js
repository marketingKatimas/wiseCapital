...
function updateContent(language) {
    if (language === 'bm') {
        ...
        RenovationLoanServicesDes.textContent = 'Dapatkan modal untuk ubahsuai rumah anda yang sekarang kepada rumah impian! Berikan interior rupa yang baharu dengan pembiayaan fleksibel kami, pada kadar faedah yang rendah. Jadikan projek ubahsuai rumah anda suatu kenyataan!';
    } else {
        RenovationLoanServices.textContent = 'Renovation Loan';
        RenovationLoanServicesDes.textContent = 'Get the necessary funds to renovate your current home into your ideal home! Give your interior a fresh new look with our flexible terms with a low interest rate and make your home project a reality!';
    }
}
