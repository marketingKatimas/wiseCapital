...
const BusinessLoanTitle = document.getElementById('BusinessLoanTitle');
...
//Content
const BusinessLoanServices = document.getElementById('BusinessLoanServices');
const BusinessLoanServicesDes = document.getElementById('BusinessLoanServicesDes');
...
function updateTitle(language) {
    if (language === 'bm') {
        ...
        BusinessLoanTitle.textContent = 'Pembiayaan Bisnes';
    } else {
        OurServicesTitle.textContent = 'Our Services';
        HomeTitle.textContent = 'Home';
        BusinessLoanTitle.textContent = 'Business Loan';
    }
}
...
function updateContent(language) {
    if (language === 'bm') {
        BusinessLoanServices.textContent = 'Pembiayaan Bisnes';
        BusinessLoanServicesDes.textContent = 'Pembiayaan bisnes kami menyediakan modal untuk bisnes anda supaya anda dapat kembangkan perniagaan dan urus cash flow anda dengan lebih bijak. Dengan kadar faedah rendah, pilih pembiayaan bisnes kami untuk perkembangan perniagaan anda.';
    } else {
        BusinessLoanServices.textContent = 'Business Loan';
        BusinessLoanServicesDes.textContent = 'Our business loan provides capital for your business to expand your startups and manage better cash flow. With our low interest rate, we can help fuel your business journey better';
    }
}
