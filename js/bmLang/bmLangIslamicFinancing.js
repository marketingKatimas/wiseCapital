...
const IslamicFiancing = document.getElementById('IslamicFiancing');
...
//Content
const IslamicFinacingServices = document.getElementById('IslamicFinacingServices');
const IslamicFinacingServicesDes = document.getElementById('IslamicFinacingServicesDes');
...
function updateTitle(language) {
    if (language === 'bm') {
        ...
        IslamicFiancing.textContent = 'Pembiayaan Islamik';
    } else {
        OurServicesTitle.textContent = 'Our Services';
        HomeTitle.textContent = 'Home';
        IslamicFiancing.textContent = 'Islamic Financing';
    }
}
...
function updateContent(language) {
    if (language === 'bm') {
        IslamicFinacingServices.textContent = 'Pembiayaan Islamik';
        IslamicFinacingServicesDes.textContent = 'Pembiayaan Islamik kami patuh pada syariah dan mengikuti sistem tawarruq, memastikan pembiayaan kami telus dan adil. Kecapi matlamat kewangan anda dengan yakin dan amanah!';
    } else {
        IslamicFinacingServices.textContent = 'Islamic Financing';
        IslamicFinacingServicesDes.textContent = 'Our Islamic loans are shariah-compliant with complete adherence to the tawarruq system, ensuring transparency and fairness. Pursue your financial goals with us with confidence and trust!';
    }
}
