...
function updateContent(language) {
    if (language === 'bm') {
        ...
        EducationLoanServicesDes.textContent = 'Tumpukan pada pendidikan anda tanpa beban kewangan! Pembiayaan Pendidikan kami merangkumi yuran tuisyen, buku teks & keperluan harian agar anda dapat fokus pada pembelajaran anda. Dengan pelan bayaran balik yang mesra pelajar, melanjutkan pelajaran menjadi lebih mudah.';
    } else {
        EducationLoanServices.textContent = 'Education Loan';
        EducationLoanServicesDes.textContent = 'Concentrate on your education without the financial burden. Our education loans cover your tuition fees, textbooks & living expenses, letting you focus on your studies. With favorable repayment terms, furthering your studies are now made easy!';
    }
}
