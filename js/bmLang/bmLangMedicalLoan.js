...
function updateContent(language) {
    if (language === 'bm') {
        ...
        MedicalLoanServicesDes.textContent = 'Kesihatan anda keutamaan kami. Dengan pembiayaan perubatan kami, dapatkan sokongan yang anda perlukan. Tumpukan kebajikan diri anda dengan pilihan bayaran balik kami yang fleksibel dan proses kelulusan yang pantas.';
    } else {
        MedicalLoanServices.textContent = 'Medical Loan';
        MedicalLoanServicesDes.textContent = 'Your health is our priority, and with our medical loan, you can receive the support you need. Focus on your well-being with our flexible repayment options and quick approval process.';
    }
}
